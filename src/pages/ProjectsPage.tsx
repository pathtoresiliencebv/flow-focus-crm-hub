...
export default function ProjectsPage() {
  ...
  // CRITICAL: Don't include headerActions in deps - it's already memoized
  // Including it creates a loop: setActions → context update → page re-render → effect runs again
  useEffect(() => {
