...
import { X, Send, Paperclip, Mic, Image, Plus, Users, MessageSquare } from "lucide-react";
...
import { useChat, ChatMessage as ChatMessageType, ChatUser } from "@/hooks/useChat";
...
export const ImprovedChatWindow = ({ onClose }: ImprovedChatWindowProps) => {
      ...
      <CardContent className="p-0 flex h-[calc(100%-80px)]">
        ...
        <div className="w-1/3 border-r">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="h-full">
            ...
            <TabsContent value="channels" className="h-[calc(100%-40px)] mt-0">
              <ScrollArea className="h-full">
                <div className="p-2 space-y-1">
                  {/* Project Channels */}
                  {projectChannels.length > 0 && (
                    <div>
                      <h4 className="text-xs font-medium text-muted-foreground mb-2 px-2">PROJECT KANALEN</h4>
                      {projectChannels.map((channel) => (
                        <div
                          key={channel.id}
                          className={`p-2 cursor-pointer rounded-lg hover:bg-accent ${
                  ...
                  {directChannels.length > 0 && (
                    <div>
                      <h4 className="text-xs font-medium text-muted-foreground mb-2 px-2">DIRECTE BERICHTEN</h4>
                  ...
                  {generalChannels.length > 0 && (
                    <div>
                      <h4 className="text-xs font-medium text-muted-foreground mb-2 px-2">ALGEMENE KANALEN</h4>
            ...
            <TabsContent value="users" className="h-[calc(100%-40px)] mt-0">
              <ScrollArea className="h-full">
                <div className="p-2">
                  <h4 className="text-xs font-medium text-muted-foreground mb-2 px-2">BESCHIKBARE PERSONEN</h4>
                  {availableUsers.map((chatUser) => (
                    ...
                    >
                      <div className="flex items-center gap-2">
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-sm font-medium truncate">{chatUser.full_name || "Onbekende gebruiker"}</p>
                          <div className="flex items-center gap-2">
                  ...
                  {availableUsers.length === 0 && (
                    <div className="p-4 text-center text-muted-foreground">
                      <p className="text-sm">Geen personen beschikbaar</p>
                      <p className="text-xs mt-1">Contact je administrator</p>
                    </div>
                  )}
                </div>
              </ScrollArea>
          ...
          {selectedChannelId ? (
            ...
            <div className="flex-1 flex items-center justify-center text-muted-foreground">
              <div className="text-center">
                ...
                <p className="text-sm mt-1">Of start een directe chat met een persoon</p>
              </div>
            </div>
          )}
        </div>
